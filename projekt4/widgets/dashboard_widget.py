...
class DashboardWidget(QWidget):
    def __init__(self, order_entry_widget_factory, main_window):
        ...
        # GridLayout: 3 rows x 5 columns (tygodnie x dni robocze)
    ...
    def get_days(self):
        ...
        weeks = []
        for week_offset in [-1, 0, 1]:  # poprzedni, bieżący, następny
    ...
    def populate_days(self):
        ...
        # USUŃ wymuszanie minimum height kontenera na całą siatkę!
        # Scroll pojawi się, gdy suma wysokości day boxów przekroczy okno
