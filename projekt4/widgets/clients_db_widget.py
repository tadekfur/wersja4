from PySide6.QtWidgets import (
    ...
    QHeaderView, QLineEdit, QDialog, QFormLayout, QMessageBox, QScrollArea, QSizePolicy
)
...
class ClientsDBWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.table.setHorizontalHeaderLabels([
            "Nr klienta", "Nazwa firmy", "Osoba kontaktowa", "Telefon", "E-mail", "Miasto", "NIP", "Adres dostawy"
        ])
    ...
    def refresh_clients(self):
        ...
        session = Session()
        clients = session.query(Client).order_by(Client.client_number.asc()).all()
        for row, client in enumerate(clients):
            ...
            for col, val in enumerate([
                ...
                # Ustaw naprzemienny kolor tła wiersza
                if row % 2 == 0:
                    bg = QColor("#f2f2f2")
                else:
                    bg = QColor("#ffffff")
